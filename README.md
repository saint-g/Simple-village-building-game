...
|----------|------|-----------|------|-------|
| 🏠 House | 10G, 20W, 5S | 5G/sec | 1x1 | Basic residential |
| 🌾 Farm | 15G, 10W, 0S | 3G/sec | 2x2 | Food production |
| 📦 Warehouse | 30G, 40W, 20S | None | 2x2 | Storage facility |
| ⛏️ Mine | 50G, 30W, 50S | 10S/sec | 2x2 | Stone extraction |
| 🪵 Lumbermill | 40G, 50W, 30S | 8W/sec | 2x2 | Wood processing |
| 🏪 Market | 60G, 40W, 40S | 10G/sec | 2x2 | Trade hub |
| 🗼 Guard Tower | 80G, 30W, 60S | None | 1x1 | Defense structure |
| ⛩️ Temple | 100G, 50W, 80S | 15G/sec | 3x3 | Monument |
...
1. **Clone the Repository**
   ```bash
   git clone https://github.com/saint-g/Simple-village-building-game.git
   cd Simple-village-building-game
